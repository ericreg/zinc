...
impl __ZincCallable_i64_to_i64 {
    fn call(&self, arg_0: i64) -> i64 {
        match self {
            ...
            Self::V0 => callables_19_channel_bounded__double_i64(arg_0),
        }
    }
}

fn callables_19_channel_bounded__double_i64(x: i64) -> i64 {
    return (x * 2);
}

#[tokio::main]
async fn main() {
    let jobs = __ZincChannel::<__ZincCallable_i64_to_i64>::bounded(1);
