...
async fn main() {
    ...
    __zinc_spawn_handles.push(tokio::spawn({ let __zinc_spawn_arg_0 = int_ch_tx.clone(); async move { sender_chan_i64(__zinc_spawn_arg_0, 42).await; } }));
    ...
    __zinc_spawn_handles.push(tokio::spawn({ let __zinc_spawn_arg_0 = int_ch2_tx.clone(); async move { double_sender_chan_i64(__zinc_spawn_arg_0, 100).await; } }));
    ...
    __zinc_spawn_handles.push(tokio::spawn({ let __zinc_spawn_arg_0 = int_ch3_tx.clone(); async move { sender_chan_i64(__zinc_spawn_arg_0, 999).await; } }));
