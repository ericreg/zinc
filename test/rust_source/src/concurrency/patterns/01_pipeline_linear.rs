...
async fn main() {
    ...
    __zinc_spawn_handles.push(tokio::spawn({ let __zinc_spawn_arg_0 = stage1.clone(); async move { concurrency_patterns_01_pipeline_linear__source_Channel(__zinc_spawn_arg_0).await; } }));
