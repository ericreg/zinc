...
async fn concurrency_select_05_helper_async__helper() -> i64 {
    ...
    __zinc_spawn_handles.push(tokio::spawn({ let __zinc_spawn_arg_0 = values.clone(); async move { concurrency_select_05_helper_async__emit_Channel(__zinc_spawn_arg_0).await; } }));
    tokio::select! {
