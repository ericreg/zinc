...
#[derive(Clone)]
struct __ZincClosureEnv_closures_04_independent_closure_envs___lambda_closures_04_independent_closure_envs__make_counter_i64_10_21 {
    x: Arc<Mutex<i64>>,
}
...
enum __ZincCallable_Unit_to_i64 {
    Closed,
    V0(__ZincClosureEnv_closures_04_independent_closure_envs___lambda_closures_04_independent_closure_envs__make_counter_i64_10_21),
}
...
impl __ZincCallable_Unit_to_i64 {
    fn call(&self, ) -> i64 {
        match self {
            ...
            Self::V0(env) => closures_04_independent_closure_envs____lambda_closures_04_independent_closure_envs__make_counter_i64_10_21(env.clone()),
        }
    }
}
...
fn closures_04_independent_closure_envs__make_counter_i64(start: i64) -> __ZincCallable_Unit_to_i64 {
    ...
    return __ZincCallable_Unit_to_i64::V0(__ZincClosureEnv_closures_04_independent_closure_envs___lambda_closures_04_independent_closure_envs__make_counter_i64_10_21 { x: __zv_closures_04_independent_closure_envs__make_counter_i64_x_i64.clone() });
}
