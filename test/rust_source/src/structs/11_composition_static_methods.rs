...
impl Default for structs_11_composition_static_methods__File {
    fn default() -> Self {
...
impl Default for structs_11_composition_static_methods__Item {
    fn default() -> Self {
        Self { path: String::new(), text: String::new(), timestamp: 0 }
    }
}
...
impl Default for structs_11_composition_static_methods__Message {
    fn default() -> Self {
