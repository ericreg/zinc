...
impl Default for structs_08_integration__BankAccount {
    fn default() -> Self {
        Self { _account_number: 0, _balance: 0, owner: String::new(), bank_name: String::new() }
    }
}
...
impl Default for structs_08_integration__Transaction {
    fn default() -> Self {
        Self { from_account: String::new(), to_account: String::new(), amount: 0, _processed: false }
    }
}
