...
impl BankAccount {
    fn new(owner: String, account_number: i32, initial_balance: i32) -> Self {
        return BankAccount {
            ...
            owner: owner,
            bank_name: String::from("Zinc Bank"),
        };
    }
...
fn main() {
    let mut alice_account = BankAccount::new(String::from("Alice"), 1001, 1000);
    let mut bob_account = BankAccount::new(String::from("Bob"), 1002, 500);
    ...
    println!("alice_account.get_balance()");
    let mut tx = Transaction::new(String::from("Alice"), String::from("Bob"), 100);
    println!("tx.describe()");
