...
class zincVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by zincParser#externRustBlock.
    def visitExternRustBlock(self, ctx:zincParser.ExternRustBlockContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustItem.
    def visitExternRustItem(self, ctx:zincParser.ExternRustItemContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#rustUseStatement.
    def visitRustUseStatement(self, ctx:zincParser.RustUseStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustType.
    def visitExternRustType(self, ctx:zincParser.ExternRustTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustFunction.
    def visitExternRustFunction(self, ctx:zincParser.ExternRustFunctionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustParameterList.
    def visitExternRustParameterList(self, ctx:zincParser.ExternRustParameterListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustParameter.
    def visitExternRustParameter(self, ctx:zincParser.ExternRustParameterContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#externRustImpl.
    def visitExternRustImpl(self, ctx:zincParser.ExternRustImplContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by zincParser#functionName.
    def visitFunctionName(self, ctx:zincParser.FunctionNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#operatorFunctionName.
    def visitOperatorFunctionName(self, ctx:zincParser.OperatorFunctionNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by zincParser#operatorSymbol.
    def visitOperatorSymbol(self, ctx:zincParser.OperatorSymbolContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by zincParser#customOperatorExpr.
    def visitCustomOperatorExpr(self, ctx:zincParser.CustomOperatorExprContext):
        return self.visitChildren(ctx)
